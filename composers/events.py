...
def EventReceiver(event_name, behavior_name):
    ...
    Usage:
    To create a class that listens for <event_name> and when it occurs
    it runs <response_function>, use:

    @EventReceiver("<event_name>", "<response_function>")
    Class X:
        def <response_function>(self, sender, details):
            <code>
